...
const OurTeachers = ({ id, BgColor, headingColor, minHeight90vh }) => {
    return(
        <HomeContainer BgColor={BgColor} id={id}>
            ...
            <Ul>
                <Li><i class="fa fa-star" aria-hidden="true"></i>{" "}Reena Shimpi{" "}<Subject>[MATHEMATICS]</Subject>{" "}<Experience>(Experience of <b style={{ color: "black" }}>10+</b> Years, Qualification- B.Sc Chem)</Experience>
                    <br /><br />
                    <P>
